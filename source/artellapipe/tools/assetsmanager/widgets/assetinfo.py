...
class StatusStack(base.BaseWidget, object):
    ...
    def ui(self):
        ...
        working_icon = artellapipe.resource.icon('working')
        published_icon = artellapipe.resource.icon('box')
...
class AssetFileButton(base.BaseWidget, object):
    ...
    def ui(self):
        ...
        folder_icon = artellapipe.resource.icon('artella')
    ...
    def _on_open_asset_file(self, file_type):
        ...
        if not file_type or not file_type in self._asset_widget.asset.ASSET_FILES:
            return
...
class WorkingAssetInfo(base.BaseWidget, object):
    ...
    def _create_asset_files_buttons(self):
        ...
        for file_type, file_icon in self._asset_widget.asset.ASSET_FILES.items():
            file_btn = AssetFileButton(self._asset_widget, defines.ARTELLA_SYNC_WORKING_ASSET_STATUS, file_type, file_icon)
