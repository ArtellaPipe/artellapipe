...
class ArtellaProgressBar(base.BaseWidget, object):
    ...
    def ui(self):
        ...
        self._progress.setStyleSheet("QProgressBar {border: 0px solid grey; border-radius:4px; padding:0px} QProgressBar::chunk {background: qlineargradient(x1: 0, y1: 1, x2: 1, y2: 1, stop: 0 rgb(" + gradient_color_0 + "), stop: 1 rgb(" + gradient_color_1 + ")); }")
