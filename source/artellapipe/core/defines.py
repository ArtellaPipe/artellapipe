...
# Defines the default icon used of the Artella project
ARTELLA_PROJECT_DEFAULT_ICON = 'artella'
...
# Defines name of the image used by default in dialogs and windows as title backgrounds
ARTELLA_TITLE_BACKGROUND_FILE_NAME = 'title_background'
