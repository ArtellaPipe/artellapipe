...
class ArtellaReferencesMetaData(object):
    ...
    def print_info(self):
        ...
        artellapipe.logger.debug('Name: {}'.format(self.name))
        artellapipe.logger.debug('Path: {}'.format(self.path))
        artellapipe.logger.debug('Maximum Version Deleted: {}'.format(self.maximum_version_deleted))
        artellapipe.logger.debug('Is Directory: {}'.format(self.is_directory))
        artellapipe.logger.debug('Is Deleted: {}'.format(self.deleted))
        artellapipe.logger.debug('Local Version: {}'.format(self.local_version))
        artellapipe.logger.debug('View Version: {}'.format(self.view_version))
        artellapipe.logger.debug('Relative Path: {}'.format(self.relative_path))
        artellapipe.logger.debug('Maximum Version: {}'.format(self.maximum_version))
        artellapipe.logger.debug('View Version Digest: {}'.format(self.view_version_digest))
        artellapipe.logger.debug('Locked: {}'.format(self.locked))
        artellapipe.logger.debug('Locked By: {}'.format(self.locked_by))
        artellapipe.logger.debug('Locked View: {}'.format(self.locked_view))
        artellapipe.logger.debug('Locked By Display: {}'.format(self.locked_by_display))
...
class ArtellaDirectoryMetaData(object):
    ...
    def print_info(self):
        ...
        artellapipe.logger.debug('Path: {}'.format(self.path))
        artellapipe.logger.debug('Header: {}'.format(self.header))
        artellapipe.logger.debug('References: {}'.format(self.references))
